...
| 무기군별 공격 패턴 | [스펙](docs/superpowers/specs/2026-08-17-weapon-attack-patterns-design.md) | [구현 기록](docs/superpowers/plans/2026-08-17-weapon-attack-patterns.md)                 |
...
한 번씩 안 끝난다. 재시도하면 통과하므로, 한 번 멈췄다고 코드 문제로 단정하지 않는다.
두세 번 돌려보고 계속 멈추면 그때 파고든다.
...
0인 상태가 영구 저장되면 전투 시작이 영영 막힌다. 실제로 한 번 발생했던 버그
